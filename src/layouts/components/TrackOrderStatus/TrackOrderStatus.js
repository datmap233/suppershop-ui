import styles from './TrackOrderStatus.module.scss';
...
function TrackOrderStatus() {
    ...
    useEffect(() => {
        const fetchApi = async () => {
            const result = await orderServices.trackOrderStatus(JSON.parse(localStorage.getItem('Login')).id);
                                                        ...
                                                        {Object.keys(data[key].listProduct).map(function (keyy) {
                                                            return (
                                                                <div className={cx('content')}>
                                                                    <span title={data[key].listProduct[keyy].name}>{data[key].listProduct[keyy].name}</span>
